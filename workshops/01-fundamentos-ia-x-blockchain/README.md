# Fundamentos IA x Blockchain - Written Guide

This README is the written workshop guide. It adapts the slide source in
[`../../tmp/01-fundamentos-ia-x-blockchain-eng.md`](../../tmp/01-fundamentos-ia-x-blockchain-eng.md)
into the build path for Workshop 1: give the application a brain with a small
Hono backend and Nebius Token Factory.
...
```text
Hoy le dimos un cerebro a la aplicación. En el siguiente workshop vamos a conectar sus integraciones para que pueda actuar.
```
